...
3. The Corporation is hereby requisitioned to dispatch a suction jetting unit and structural repair crew within 24 hours to clear line obstruction and remediate the contaminated perimeter.`,
    body_ur: `بخدمت جناب مینیجنگ ڈائریکٹر و چیف انجینئر (سیوریج)، کراچی واٹر اینڈ سیوریج کارپوریشن (KW&SC)

عنوان: گلشن اقبال بلاک 4 (ڈسکو بیکری) میں سیوریج لائن بیٹھنے پر قانونی نوٹس

آپ کو مطلع کیا جاتا ہے کہ گلشن اقبال بلاک 4 میں متعدد شہریوں نے کھلے مین ہول اور گندے پانی کے سڑک پر بہاؤ کی باقاعدہ تصدیق کی ہے۔
یہ صورتحال کراچی واٹر اینڈ سیوریج کارپوریشن ایکٹ 2023 کی دفعہ 24 کی صریح خلاف ورزی ہے اور گردونواح کے 1200 سے زائد رہائشیوں کی صحت کے لیے سنگین خطرہ ہے۔
لہٰذا مجاز اتھارٹی سے مطالبہ ہے کہ 24 گھنٹے کے اندر اندر سکشن جیٹنگ یونٹ اور مرمتی عملہ موقع پر روانہ کیا جائے۔`,
    official_status: "PENDING",
...
3. KMC Maintenance Division is requested to deploy immediate pre-cast concrete capping and reflective hazard signage.`,
    body_ur: `بخدمت جناب سینیئر ڈائریکٹر میونسپل سروسز / انجینئرنگ، کراچی میٹروپولیٹن کارپوریشن (KMC)

عنوان: مین یونیورسٹی روڈ، بالمقابل نیپا چورنگی بس اسٹاپ پر کھلے مین ہول کا سنگین حادثاتی خطرہ

موصولہ رپورٹ کے مطابق یونیورسٹی روڈ کے مرکزی راستے پر بغیر حفاظتی رکاوٹ کے 4 فٹ گہرا گڑھا اور مین ہول کھلا پڑا ہے۔
سندھ لوکل گورنمنٹ ایکٹ 2013 کے شیڈول V کے تحت شاہرائے عامہ کی حفاظت KMC کی قانونی ذمہ داری ہے۔
اس مقام پر فوری طور پر پری کاسٹ کنکریٹ سلیب نصب کیا جائے اور احتیاطی وارننگ بورڈ آویزاں کیے جائیں۔`,
    official_status: "PENDING",
