...
export const SuperAdminPage: React.FC = () => {
  ...
  const getOrgIcon = (org: string) => {
    switch (org) {
      ...
      case "KMC":
        return <Building2 className="w-5 h-5 text-sky-800" />;
      case "SSWMB":
        return <Trash2 className="w-5 h-5 text-amber-800" />;
      case "CANTONMENT":
        return <ShieldAlert className="w-5 h-5 text-purple-800" />;
      default:
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="self-start sm:self-auto h-9 px-4 text-xs font-semibold bg-emerald-900 text-white rounded-xl hover:bg-emerald-950 transition-colors inline-flex items-center gap-1.5 shadow-xs"
        >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-[10px] text-slate-400 mt-0.5">Pending Jobs</div>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-sm font-bold text-emerald-800 mt-2 flex items-center gap-1">
                  <CheckCircle2 className="w-4 h-4 text-emerald-700" />
                  <span>{overview.systemHealth.aiWorkerStatus}</span>
                </div>
                <div className="text-[10px] text-slate-400 mt-1">Ollama / Gemini</div>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-[10px] text-slate-400 mt-1">Meta Graph Hook</div>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-[10px] text-slate-400 mt-0.5">Celery / Background</div>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-[10px] text-slate-400 mt-0.5">Avg Per Perception</div>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5">
                ...
                <div className="text-[10px] text-slate-400 mt-0.5">PostgreSQL 16</div>
              </div>
            </div>
            ...
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-600 leading-relaxed">
              <strong className="text-slate-900">Statutory Inter-Agency Routing Rule:</strong>{" "}
